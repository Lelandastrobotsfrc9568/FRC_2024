 ...
 * will override.
 */
public class IntakeRollerClaw extends Command {
  PWMRollerClaw m_rollerclaw;

  // CANLauncher m_launcher;

  /** Creates a new LaunchRollerClaw. */
  public IntakeRollerClaw (PWMRollerClaw rollerclaw) {
  ...
  public void initialize() {
    // Set the wheels to intake speed which is POSITIVE for Lake City
